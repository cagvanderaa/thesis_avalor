...
class VisualServoController:
    def __init__(self):
        ...
        self.pid_control_horizontal = PIDController(Kp=60, Ki=0, Kd=3)
        self.pid_control_vertical = PIDController(Kp=2.0, Ki=0, Kd=0.05)
        self.pid_control_distance = PIDController(Kp=40, Ki=0, Kd=8)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if uv is not None and distance is not None:
                ...
                delta_r_forward = self.pid_control_distance.update(distance -2, dt)
